...
| Dashboard | Employees |
|---|---|
| ![Dashboard](/screenshots/dashboard-overview.png) | ![Employees](/screenshots/employee-dashboard.png) |
| Incidents | Pods |
| ![Incidents](/screenshots/incidents-dashboard.png) | ![Pods](/screenshots/kubernetes-pods.png) |
| Resume Analyzer |
